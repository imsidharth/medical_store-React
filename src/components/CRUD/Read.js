      ...
      <div className="container w-50 bg-white rounded mt-5 p-3">
        <div className="row">
          <div className="col-12">
            <h1 className="text-center my-4" style={{ fontWeight: 'bold', color: '#17a2b8' }}>View All Medicines</h1>
          </div>
        </div>
        <div className="row">
            ...
            <div style={{ display: 'flex',alignItems: 'flex-start' }}>
                ...
                <form className="search-container" style={{ width: '70%' }}>
                    <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                        ...
                        <button className="btn btn-small customBtnClrAlt" type="button" onClick={handleSearch} style={{ position: 'absolute', right: 0, top: 19, height: '100%', borderRadius: '0 5px 5px 0', boxSizing: 'border-box' }}>
