        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ">
            <li className="nav-item customNavItem">
              <NavLink to={"/readAPI"} className={ 'nav-link font-weight-bold customNavItem'+(status => status.isActive ? 'active' : '')} style={{ color: '#17a2b8' }}>
                  Medicines
              </NavLink>
            </li>
            <li className="nav-item customNavItem">
              <NavLink to={"/createAPI"} className={ 'nav-link font-weight-bold customNavItem'+(status => status.isActive ? 'active' : '')} style={{ color: '#17a2b8' }}>
                  Add New Medicine
              </NavLink>
            </li>
            <li className="nav-item customNavItem">
              <NavLink to={"/aboutus"} className={ 'nav-link font-weight-bold customNavItem'+(status => status.isActive ? 'active' : '')} style={{ color: '#17a2b8' }}>
                      About us
              </NavLink>
            </li>
          ...
          <ul className="navbar-nav">
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle customNavItem" href="#" role="button" data-toggle="dropdown" aria-expanded="false" style={{ color: '#17a2b8' }}>
